...
console.log(localStorage.getItem('template.theme'));
...
function goBack() {
  if (document.referrer) {
    ...
    console.warn('No referrer found, redirecting to home.');
    window.location.href = '/index.html'; // Replace with your fallback page
  }
}
function applyWshadStyling() {
  let theme = getCurrentTheme();
  console.log("applyWshadStyling", theme);
  // Select all elements with the 'wshad' class
  const elements = document.querySelectorAll('.wshad');

  elements.forEach((element) => {
    if (theme === 'light') {
      // Apply centered glowing shadow for light theme
      element.style.textShadow = "0px 0px 16px #babec8";
    } else {
      // Apply centered glowing shadow for dark theme
      // element.style.textShadow = "";
      element.style.textShadow = "0 0 8px #000000, 0 0 16px #000000";
    }
  });
}
...
document.addEventListener('DOMContentLoaded', applyWshadStyling);
